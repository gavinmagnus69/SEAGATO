 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReaderInterface< ::Track>> sendTracksTest(::grpc::ClientContext* context, const ::User& request) {
      return std::unique_ptr< ::grpc::ClientReaderInterface< ::Track>>(sendTracksTestRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::Track>> AsyncsendTracksTest(::grpc::ClientContext* context, const ::User& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::Track>>(AsyncsendTracksTestRaw(context, request, cq, tag));
    }
  ...
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReader< ::Track>> sendTracksTest(::grpc::ClientContext* context, const ::User& request) {
      return std::unique_ptr< ::grpc::ClientReader< ::Track>>(sendTracksTestRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::Track>> AsyncsendTracksTest(::grpc::ClientContext* context, const ::User& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::Track>>(AsyncsendTracksTestRaw(context, request, cq, tag));
    }
  ...
  template <class BaseClass>
  class WithAsyncMethod_sendTracksTest : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_sendTracksTest() {
      ::grpc::Service::MarkMethodAsync(3);
    }
    ~WithAsyncMethod_sendTracksTest() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ...
    void RequestsendTracksTest(::grpc::ServerContext* context, ::User* request, ::grpc::ServerAsyncWriter< ::Track>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  template <class BaseClass>
  class WithCallbackMethod_sendTracksTest : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_sendTracksTest() {
      ::grpc::Service::MarkMethodCallback(3,
          new ::grpc::internal::CallbackServerStreamingHandler< ::User, ::Track>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::User* request) { return this->sendTracksTest(context, request); }));
    }
    ~WithCallbackMethod_sendTracksTest() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status sendTracksTest(::grpc::ServerContext* /*context*/, const ::User* /*request*/, ::grpc::ServerWriter< ::Track>* /*writer*/) override {
  ...
  template <class BaseClass>
  class WithGenericMethod_sendTracksTest : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_sendTracksTest() {
      ::grpc::Service::MarkMethodGeneric(3);
    }
    ~WithGenericMethod_sendTracksTest() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status sendTracksTest(::grpc::ServerContext* /*context*/, const ::User* /*request*/, ::grpc::ServerWriter< ::Track>* /*writer*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_sendTracksTest : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_sendTracksTest() {
      ::grpc::Service::MarkMethodRaw(3);
    }
    ~WithRawMethod_sendTracksTest() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status sendTracksTest(::grpc::ServerContext* /*context*/, const ::User* /*request*/, ::grpc::ServerWriter< ::Track>* /*writer*/) override {
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_sendTracksTest : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_sendTracksTest() {
      ::grpc::Service::MarkMethodRawCallback(3,
          new ::grpc::internal::CallbackServerStreamingHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const::grpc::ByteBuffer* request) { return this->sendTracksTest(context, request); }));
    }
    ~WithRawCallbackMethod_sendTracksTest() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status sendTracksTest(::grpc::ServerContext* /*context*/, const ::User* /*request*/, ::grpc::ServerWriter< ::Track>* /*writer*/) override {
  ...
  typedef WithStreamedUnaryMethod_sendAudio<WithStreamedUnaryMethod_sendTrackList<Service > > StreamedUnaryService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithSplitStreamingMethod_sendTracksTest : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithSplitStreamingMethod_sendTracksTest() {
        ...
        new ::grpc::internal::SplitServerStreamingHandler<
          ::User, ::Track>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerSplitStreamer<
                     ::User, ::Track>* streamer) {
                       return this->StreamedsendTracksTest(context,
                         streamer);
                  }));
    }
    ~WithSplitStreamingMethod_sendTracksTest() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status sendTracksTest(::grpc::ServerContext* /*context*/, const ::User* /*request*/, ::grpc::ServerWriter< ::Track>* /*writer*/) override {
