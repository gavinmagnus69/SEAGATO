...
namespace Interface
{
    ...
    {   
        public:
            ...
            virtual std::vector<Entity::Track> fetch_tracks_batches(const std::string& ,const std::vector<std::string>& track_names) = 0;
            virtual int getTracksNames(const std::string&, std::vector<std::string>&) = 0;
